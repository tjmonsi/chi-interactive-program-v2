...
const fragments = {'page-home': () => import(/* webpackChunkName: "page-home" */ 'page-home'), 'page-day': () => import(/* webpackChunkName: "page-day" */ 'page-day'), 'page-not-found': () => import(/* webpackChunkName: "page-not-found" */ 'page-not-found'), 'page-not-authorized': () => import(/* webpackChunkName: "page-not-authorized" */ 'page-not-authorized'), 'page-login': () => import(/* webpackChunkName: "page-login" */ 'page-login'), 'page-authorized': () => import(/* webpackChunkName: "page-authorized" */ 'page-authorized'), 'page-test': () => import(/* webpackChunkName: "page-test" */ 'page-test'), 'page-test-two': () => import(/* webpackChunkName: "page-test-two" */ 'page-test-two')};
